...
describe User do
	before  do 
		 @user = User.new(name: "Example User", email: "user77@example.com",
  ...
  describe "when email format is invalid" do
	...
	describe "when password does not match confimation" do
  ...
  describe "micropost associations" do
	  ...
	  before { @user.save }
	  # let! forces the variable to come into existence immediately- 
	  # see listing 10.13
	  ...
	  # association itself, by checking (as indicated in Table 10.11) 
	  # that user.microposts is an array of microposts
